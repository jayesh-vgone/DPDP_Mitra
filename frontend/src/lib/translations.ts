...
const UI = {
  ...
  // ── Internal Audit ───────────────────────────────────────────────────────────
  auditPageTitle:         { en: 'Internal Audit', hi: 'आंतरिक लेखापरीक्षा' },
  auditPageSubtitle:      { en: 'Targeted 90-day retest of your weakest compliance areas', hi: 'आपके कमज़ोर अनुपालन क्षेत्रों की लक्षित 90-दिन की पुनः जांच' },
  auditNotApplicableTitle: { en: 'Complete your first assessment to begin', hi: 'शुरू करने के लिए पहला मूल्यांकन पूरा करें' },
  auditNotApplicableBody:  { en: 'Internal audits become available 90 days after your first full DPDP compliance assessment. Run an assessment from the Dashboard to get started.', hi: 'पहले पूर्ण DPDP अनुपालन मूल्यांकन के 90 दिन बाद आंतरिक लेखापरीक्षा उपलब्ध होती है।' },
  auditGoToAssessment:    { en: 'Run Assessment', hi: 'मूल्यांकन चलाएं' },
  auditCycleLabel:        { en: 'Audit Cycle', hi: 'लेखापरीक्षा चक्र' },
  auditDueDateLabel:      { en: 'Due Date', hi: 'नियत तारीख' },
  auditAvailableIn:       { en: 'Available in {n} days', hi: '{n} दिनों में उपलब्ध' },
  auditDueSince:          { en: 'Due since {n} day(s)', hi: '{n} दिन से नियत है' },
  auditTargetCategories:  { en: 'Categories being retested', hi: 'पुनः परीक्षण की जाने वाली श्रेणियां' },
  auditTargetEmpty:       { en: 'No high-risk areas — your next audit is a quick confirmation only', hi: 'कोई उच्च-जोखिम क्षेत्र नहीं — आपकी अगली लेखापरीक्षा केवल एक त्वरित पुष्टि है' },
  auditTakeBtn:           { en: 'Take Internal Audit', hi: 'आंतरिक लेखापरीक्षा करें' },
  auditLockedBtn:         { en: 'Not yet available', hi: 'अभी उपलब्ध नहीं' },
  auditInProgressTitle:   { en: 'Audit In Progress', hi: 'लेखापरीक्षा जारी है' },
  auditInProgressBody:    { en: 'You have an audit in progress. Resume it to complete your responses.', hi: 'आपकी एक लेखापरीक्षा जारी है। अपने उत्तर पूरे करने के लिए इसे फिर से शुरू करें।' },
  auditResumeBtn:         { en: 'Resume Audit', hi: 'लेखापरीक्षा जारी रखें' },
  auditWizardTitle:       { en: 'Internal Audit', hi: 'आंतरिक लेखापरीक्षा' },
  auditWizardSubtitle:    { en: 'Retesting {n} risk area(s) from your last assessment', hi: 'आपके पिछले मूल्यांकन के {n} जोखिम क्षेत्रों की पुनः जांच' },
  auditSubmit:            { en: 'Submit Audit', hi: 'लेखापरीक्षा सबमिट करें' },
  auditSubmitting:        { en: 'Submitting…', hi: 'सबमिट हो रहा है…' },
  auditSubmitError:       { en: 'Submission failed. Please try again.', hi: 'सबमिशन विफल। कृपया फिर से प्रयास करें।' },
  auditResultTitle:       { en: 'Audit Complete', hi: 'लेखापरीक्षा पूर्ण' },
  auditResultBody:        { en: 'Your compliance scores have been updated for the audited categories. Next audit due:', hi: 'लेखापरीक्षित श्रेणियों के लिए आपके अनुपालन स्कोर अपडेट किए गए हैं। अगली लेखापरीक्षा की नियत तारीख:' },
  auditGoToDashboard:     { en: 'View Dashboard', hi: 'डैशबोर्ड देखें' },
  auditHistoryTitle:      { en: 'Audit History', hi: 'लेखापरीक्षा इतिहास' },
  auditHistoryEmpty:      { en: 'No completed audits yet.', hi: 'अभी तक कोई पूर्ण लेखापरीक्षा नहीं।' },
  auditHistoryCycle:      { en: 'Cycle', hi: 'चक्र' },
  auditHistoryCompleted:  { en: 'Completed', hi: 'पूर्ण' },
  auditHistoryScores:     { en: 'Scores', hi: 'स्कोर' },
  // Dashboard overdue banner
  auditBannerTitle:       { en: 'Internal audit overdue', hi: 'आंतरिक लेखापरीक्षा अतिदेय है' },
  auditBannerBody:        { en: 'Due since {n} day(s). Retesting {cats}.', hi: '{n} दिन से नियत है। {cats} की पुनः जांच।' },
  auditBannerCta:         { en: 'Go to Internal Audit →', hi: 'आंतरिक लेखापरीक्षा पर जाएं →' },

  // ── Email OTP verification ───────────────────────────────────────────────────
  otpPageTitle:           { en: 'Verify your email', hi: 'ईमेल सत्यापित करें' },
  otpPageSubtitle:        { en: 'Enter the 6-digit code sent to {email}', hi: '{email} पर भेजा गया 6-अंक का कोड दर्ज करें' },
  otpInputLabel:          { en: 'Verification code', hi: 'सत्यापन कोड' },
  otpInputPlaceholder:    { en: '000000', hi: '000000' },
  otpSubmitBtn:           { en: 'Verify', hi: 'सत्यापित करें' },
  otpSubmitting:          { en: 'Verifying…', hi: 'सत्यापन हो रहा है…' },
  otpResendBtn:           { en: 'Resend code', hi: 'कोड फिर से भेजें' },
  otpResendCooldown:      { en: 'Resend in {n}s', hi: '{n}s में फिर भेजें' },
  otpResendSent:          { en: 'New code sent!', hi: 'नया कोड भेजा गया!' },
  otpExpiredError:        { en: 'Code expired or not found — request a new one', hi: 'कोड समाप्त हो गया या नहीं मिला — नया कोड मांगें' },
  otpInvalidError:        { en: 'Incorrect code — {n} attempt(s) remaining', hi: 'गलत कोड — {n} प्रयास शेष' },
  otpTooManyError:        { en: 'Too many wrong attempts — please request a new code', hi: 'बहुत अधिक गलत प्रयास — कृपया नया कोड मांगें' },
  otpAlreadyVerified:     { en: 'Email already verified — please sign in', hi: 'ईमेल पहले से सत्यापित है — साइन इन करें' },
  otpEmailNotVerified:    { en: 'Please verify your email before signing in', hi: 'साइन इन करने से पहले अपना ईमेल सत्यापित करें' },
  otpGoToVerify:          { en: 'Verify email', hi: 'ईमेल सत्यापित करें' },
